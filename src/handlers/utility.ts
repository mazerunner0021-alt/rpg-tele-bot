...
const HELP_TEXT = [
  ...
  "",
  "<b>Feed</b> (needs an approved, cast character)",
  "/post — post a photo to the Feed as your character (📸 Feed topic only)",
  "/persona — pick/change who you post and comment as in the Feed",
