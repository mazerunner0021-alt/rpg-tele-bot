...
const HELP_TEXT = [
  ...
  "",
  "<b>Feed</b> (self-service, no approval needed)",
  "/post — post a photo to the Feed (📸 Feed topic only); first time asks for a name to post under",
  "/feed — see, switch, or create Feed accounts",
  "Reply to a post to comment; tap \"📱 View as Post\" to open it as a social post",
  "",
  "<b>Anywhere</b>",
